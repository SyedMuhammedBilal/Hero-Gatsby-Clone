					...
					<div className="row no-gutters gx-0 ajax-loop">
						<div className="w-100">
							<div className="row gx-0 no-gutters align-items-stretch">
								<div className="col-md-6 gx-0 row no-gutters align-items-stretch">
									<div className="item card-item justify-content-center d-flex item-318 col-6">
										{' '}
										<a
											...
											title="UNTUCKit and HERO® Partner to Help Online Shoppers Find the Perfect Fit"
											data-wpel-link="internal"
										>
											<figure className="card-case-img justify-content-center d-flex text-center mb-0">
												<img
									...
									<div className="item card-item d-flex item-194 col-6">
										{' '}
										<a
											className="card card-case-study text-white w-100 rounded-0"
											href="https://www.usehero.com/customer-stories/rag-bone-and-hero-are-engineering-the-new-omni-experience/"
											title="rag & bone Helps Online Shoppers Find the Perfect Fit With HERO®"
											data-wpel-link="internal"
										>
											<figure className="card-case-img justify-content-center d-flex text-center mb-0">
												<img
									...
									<div className="item card-item gx-0 d-flex item-327 col-6">
										{' '}
										<a
											className="card card-case-study text-white w-100 rounded-0"
											href="https://www.usehero.com/customer-stories/how-harvey-nichols-is-creating-a-hyper-connected-army-of-personal-shoppers/"
											title="Harvey Nichols Is Taking Personal Shopping Virtual With HERO®"
											data-wpel-link="internal"
										>
											<figure className="card-case-img justify-content-center d-flex text-center mb-0">
												<img
									...
									>
										...
										<div className="card-body p-0 border-0 rounded-0 bg-transparent">
											<p className="card-title heading-xs mb-5" style={{ fontSize: '25px' }}>
												Herman Miller Group Extends High-Touch Service to Online Shoppers With
												HERO®
											</p>
										</div>
										<div className="card-footer p-0 border-0 rounded-0 bg-transparent">
											<p className="card-text eyebrow-sm mb-0">Read full story</p>
										</div>
									</a>
								</div>
							</div>
						</div>
						<div className="item card-item d-flex item-272 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								...
								title="Annoushka Brings Jewelry to Life Virtually With HERO®"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-2523 col-6 col-md-3">
							{' '}
							<div className="card card-case-study text-white w-100 rounded-0 card-disabled">
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-1490 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								href="https://www.usehero.com/customer-stories/neals-yard-remedies-hero-partnership/"
								title="Neal’s Yard Remedies & HERO® Deliver Decades of Holistic Health & Beauty Virtually"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-2520 col-6 col-md-3">
							{' '}
							<div className="card card-case-study text-white w-100 rounded-0 card-disabled">
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-294 col-md-6">
							<a
								...
								title="Jonathan Adler Delivers the Experience of the Showroom Virtually With HERO®"
								data-wpel-link="internal"
							>
								<div className="card-body p-0 border-0 rounded-0 bg-transparent">
									<p className="card-title heading-xs mb-5" style={{ fontSize: '25px' }}>
										“Helps us bridge the gap between our physical and online showrooms.”
									</p>
								</div>
						...
						<div className="item card-item d-flex item-2517 col-6 col-md-3">
							{' '}
							<div className="card card-case-study text-white w-100 rounded-0 card-disabled">
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-227 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								href="https://www.usehero.com/customer-stories/introducing-three-store-now-a-partnership-between-hero-and-three/"
								title="Three Partners With HERO® to Launch Three Store Now"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-2888 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								href="https://www.usehero.com/customer-stories/innersense/"
								title="Innersense Delivers the Hair Salon Experience Virtually With HERO®"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-2512 col-6 col-md-3">
							{' '}
							<div className="card card-case-study text-white w-100 rounded-0 card-disabled">
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-334 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								href="https://www.usehero.com/customer-stories/inside-heals-mission-to-stay-ahead-of-the-curve-with-style-advice-on-demand/"
								title="Heal’s Delivers Centuries of Design Wisdom to Online Shoppers With HERO®"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-2509 col-6 col-md-3">
							{' '}
							<div className="card card-case-study text-white w-100 rounded-0 card-disabled">
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-1093 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								...
								title="Accent Group Partners With HERO® to Bring Virtual Shopping to Its Global Brands"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-2895 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								href="https://www.usehero.com/customer-stories/the-detox-market/"
								title="The Detox Market Brings Green Beauty to Online Shoppers With HERO®"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-304 col-md-6">
							<a
								className="card card-case-study text-white ft__sm w-100 rounded-0 p-10"
								href="https://www.usehero.com/customer-stories/hero-announces-partnership-with-credo-beauty/"
								title="Credo Helps Online Shoppers Find Clean Beauty Virtually With HERO®"
								data-wpel-link="internal"
							>
								<div className="card-body p-0 border-0 rounded-0 bg-transparent">
									<p className="card-title heading-xs mb-5" style={{ fontSize: '25px' }}>
										“We are seeing off the chart results with virtual selling”
									</p>
								</div>
								<div className="card-footer p-0 border-0 rounded-0 bg-transparent d-flex justify-content-between align-items-end">
									<p className="card-text eyebrow-sm mb-0">Read full story</p>
						...
						<div className="item card-item d-flex item-1600 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								href="https://www.usehero.com/customer-stories/faherty/"
								title="Faherty Teams Up With HERO® to Launch Virtual Shopping Service"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-2491 col-6 col-md-3">
							{' '}
							<div className="card card-case-study text-white w-100 rounded-0 card-disabled">
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-1682 col-6 col-md-3">
							{' '}
							<a
								className="card card-case-study text-white w-100 rounded-0"
								href="https://www.usehero.com/customer-stories/abc-carpet-home-hero-partnership/"
								title="HERO® Helps Bring abc carpet & home to a New Generation of Shoppers"
								data-wpel-link="internal"
							>
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
						...
						<div className="item card-item d-flex item-2488 col-6 col-md-3">
							{' '}
							<div className="card card-case-study text-white w-100 rounded-0 card-disabled">
								<figure className="card-case-img justify-content-center d-flex text-center mb-0">
									<img
